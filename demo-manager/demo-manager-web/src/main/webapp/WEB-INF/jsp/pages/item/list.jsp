...
<head>
    ...
    <script type="text/html" id="zhuangtaiTpl">
        <input type="checkbox" name="zhuangtai" id="{{d.id}}" value="{{d.zhuangtai}}" lay-skin="switch" lay-text="在售|下架" lay-filter="zhuangtai" {{1==d.status?'checked':''}}>
    </script>
    ...
    layui.use(['table', 'admin', 'jquery', 'layer','form'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'id', title: '商品编号', width: 150,style:'background-color: #D0D0D0; color: #fff;',sort: true,edit:'text',fixed:'left'},
                {field: 'title', title: '商品名称',width: 300, sort: true},
                {field: 'sellPoint', title: '商品卖点',width: 300, sort: true},
                {field: 'catName', title: '分类名称',width: 100,sort: true,edit:'text'},
                {field: 'status', title: '商品状态',width: 100,sort: true,edit:'text'},
